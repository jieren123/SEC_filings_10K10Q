...
df = pd.read_csv('10k_label_frequency_per_row.csv')
...
df = pd.read_csv('10k_label_frequency_final.csv')
...
plt.xlabel('Label')
plt.ylabel('Count')
plt.title('10k-filings Sentiment Distribution')
...
plt.savefig('10k_sentiment_distribution.jpg')
